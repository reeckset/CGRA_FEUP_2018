...
class LightingScene extends CGFscene
{
	...
	init(application)
	{
		...
		this.myPaperPlane = new MyPaperPlane(this);
	...
	display()
	{
		...
		//MyPaperPlane
		this.pushMatrix();
		this.translate(this.myPaperPlane.x,this.myPaperPlane.y,8);
		this.scale(0.25,0.25,0.25);
		this.myPaperPlane.displayAnimated();
		this.popMatrix();
	...
	update(currTime){
		...
		this.myPaperPlane.update(dTime);
	}
};
